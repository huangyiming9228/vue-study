<template>
    <div class="ui centered card">
        ...
        <div class="ui bottom attached green basic button" v-show="todo.done">已完成</div>
        <div class="ui bottom attached red basic button" v-show="!todo.done" @click="completeTodo(todo)">点击完成</div>
    </div>
</template>
